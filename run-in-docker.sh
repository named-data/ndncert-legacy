...
docker create --name ndnop-process-request-runner -ti --rm -e HOME=/home --net=host cawka/ndnop-process-requests:latest /usr/bin/ndnop-process-requests >/dev/null
